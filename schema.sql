...
create table
  public.catalog_log (
    ...
    sku text not null,
    bought bigint null,
    sales_price bigint not null default '0'::bigint,
...
INSERT INTO potion_menu (sku, name, red, green, blue, dark) VALUES 
    ('0R_0G_0B_100D', 'Mystery potion', 0, 0, 0, 100), 
    ('0R_0G_50B_50D', 'Mystery potion', 0, 0, 50, 50), 
    ('0R_0G_100B_0D', 'Mystery potion', 0, 0, 100, 0), 
    ('0R_50G_0B_50D', 'Mystery potion', 0, 50, 0, 50), 
    ('0R_50G_50B_0D', 'Mystery potion', 0, 50, 50, 0), 
    ('0R_100G_0B_0D', 'Mystery potion', 0, 100, 0, 0), 
    ('50R_0G_0B_50D', 'Mystery potion', 50, 0, 0, 50), 
    ('50R_0G_50B_0D', 'Mystery potion', 50, 0, 50, 0), 
    ('50R_50G_0B_0D', 'Mystery potion', 50, 50, 0, 0), 
    ('100R_0G_0B_0D', 'Mystery potion', 100, 0, 0, 0);